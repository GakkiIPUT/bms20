...
<body>
	...
	<main>
		...
		<form action="<%=request.getContextPath()%>/view/inquiryCheck.jsp"
			method="post">
			<table align="center" style="margin-top: 20px;">
				...
				<tr>
					...
					<td><label><input type="radio" name="title"
							value="書籍について" checked> 書籍について</label> <label><input
							type="radio" name="title" value="購入について"> 購入について</label> <label><input
							type="radio" name="title" value="その他"> その他</label></td>
				</tr>
				<tr>
