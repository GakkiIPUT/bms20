...
<body>
	...
	<main>
		<div class="nav-header">
			<div class="nav-header-links">
				<a href="<%=request.getContextPath()%>/view/menu.jsp">[メニュー]</a> <a
					href="<%=request.getContextPath()%>/listInquiry">[お問い合わせ一覧]</a>
			</div>
		...
		<table align="center" border="1"
			...
			<tr>
				<th width="150"
					style="background-color: #e0e0e0; text-align: right; padding: 5px;">名前：</th>
				<td width="350" style="padding: 5px;"><%=inquiry.getName()%></td>
			</tr>
			<tr>
				<th
					style="background-color: #e0e0e0; text-align: right; padding: 5px;">電話番号：</th>
				<td style="padding: 5px;"><%=inquiry.getPhone() != null ? inquiry.getPhone() : "未入力"%></td>
			</tr>
			<tr>
				<th
					style="background-color: #e0e0e0; text-align: right; padding: 5px;">E-mail：</th>
				<td style="padding: 5px;"><%=inquiry.getEmail()%></td>
			</tr>
			<tr>
				<th
					style="background-color: #e0e0e0; text-align: right; padding: 5px;">住所：</th>
				<td style="padding: 5px;"><%=inquiry.getAddress() != null ? inquiry.getAddress() : "未入力"%></td>
			</tr>
			<tr>
				<th
					style="background-color: #e0e0e0; text-align: right; padding: 5px;">タイトル：</th>
